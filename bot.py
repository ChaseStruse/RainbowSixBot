# firstbot by CaptSnoodle

# TODO Find out how to close the connection to the bot, that is why it is freezing in the terminal
# TODO Change the help to include the ranked Commands
